/*
 FILE ARCHIVED ON 0:08:44 Dec 19, 2013 AND RETRIEVED FROM THE
 INTERNET ARCHIVE ON 13:35:00 Mar 19, 2017.
 ...
 * /web/20131219000844/http://jquery.com/
 *
 * Includes Sizzle.js
 * /web/20131219000844/http://sizzlejs.com/
 *
 * Copyright 2012 jQuery Foundation and other contributors
 * Released under the MIT license
 * /web/20131219000844/http://jquery.org/license
 *
...
(function (e, t) {
    ...
    jQuery(function () {
        return $(".email-form").each(function () {
            return $(this).live("ajax:beforeSend", function () {
                return $(this).find(".loader").css({visibility: "visible"})
            }).live("ajax:complete", function () {
                return $(this).find(".loader").css({visibility: "hidden"})
            })
        })
    })
